...
local function PlayerLogin(event, player)--玩家登录
	player:SendBroadcastMessage("欢迎来到|cFF0070d0魔兽世界巫妖王之怒公益服|r,本游戏纯仿官方设定!")
	player:SendBroadcastMessage("使用了最新|cFFF000A0AZ核心+LUA插件|r,给您带来轻松的游戏体验!")
	player:SendBroadcastMessage("游戏整体所有|cFFFF0000修复高达99%|r,真正的官方怀旧体验")
